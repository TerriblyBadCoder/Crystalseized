...
public class ModBiomeModifiers {
    ...
    public static final ResourceKey<BiomeModifier> ADD_GAS = registerKey("add_gas");
    ...
    public static void bootstrap(BootstapContext<BiomeModifier> context) {
        ...
        context.register(ADD_GAS, new ForgeBiomeModifiers.AddFeaturesBiomeModifier(
                biomes.getOrThrow(BiomeTags.IS_END),
                HolderSet.direct(placedFeatures.getOrThrow(ModPlacedFeatures.GAS_PLACED_KEY)),
                GenerationStep.Decoration.UNDERGROUND_DECORATION));
